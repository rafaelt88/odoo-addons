    ...
    comboButtons.forEach(button => {
        button.addEventListener('click', async function (e) {
            ...
            try {
                ...
                console.log('Sending request to /shop/combo/add with combo_id:', comboId);
                ...
                if (response.ok) {
                    ...
                    } else if (finalUrl.includes('/shop') && !finalUrl.includes('/shop/cart')) {
                        // Redirected to shop - might be an error
                        console.warn('Redirected to shop page, combo might not have been added');
                    ...
                    throw new Error(`HTTP ${response.status}: Failed to add combo to cart`);
                }
